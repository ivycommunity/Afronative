    ...
    const fetchLessons = async () => {
      ...
      try {
        const response = await client.getEntries({
          ...
          "fields.typeOfLesson": "Speaking"
        });

        const speakingLessons: Lesson[] = response.items.map((item: any) => {
          let audioUrl = "";
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        ...
        <View style={styles.userInfo}>
          ...
          <Text style={styles.subText}>Speaking Lessons</Text>
      ...
      {loading ? (
        <View style={styles.loadingContainer}>
          ...
          <Text style={styles.loadingText}>Loading speaking lessons...</Text>
        </View>
      ) : (
        <ScrollView
        ...
        >
          <View style={styles.section}>
            <View style={[styles.sectionHeader, { backgroundColor: "#D8BFD8" }]}>
              <Image 
                source={require("../../assets/images/speaking.png")} 
                style={styles.sectionIcon} 
              />
              <View style={styles.sectionTitleContainer}>
                <Text style={styles.sectionTitle}>Speaking Lessons</Text>
                <Text style={styles.sectionDescription}>Practice pronunciation and conversation</Text>
              </View>
            </View>
            ...
            {lessons.length > 0 ? (
              ...
              <View style={styles.noLessonsContainer}>
                <Text style={styles.noLessonsText}>No speaking lessons available yet</Text>
