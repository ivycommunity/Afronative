...
export default function VideoLessonsPage() {
  ...
  // Fetch video lessons from Contentful
  useEffect(() => {
    const fetchLessons = async () => {
      ...
      try {
        const response = await client.getEntries({
          ...
          "fields.typeOfLesson": "Videos"
        });

        const videoLessons: Lesson[] = response.items.map((item: any) => {
          let videoUrl = "";

          // Handle video field
          if (item.fields.video && item.fields.video.fields && item.fields.video.fields.file) {
            const videoFileUrl = item.fields.video.fields.file.url;
            videoUrl = videoFileUrl.startsWith("http") ? videoFileUrl : `https:${videoFileUrl}`;
          }

          return {
            id: item.sys.id,
            title: item.fields.lessonTitle || "Unnamed Video Lesson",
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        ...
        <View style={styles.userInfo}>
          ...
          <Text style={styles.subText}>Video Lessons</Text>
      ...
      {loading ? (
        ...
        >
          <View style={styles.section}>
            <View style={[styles.sectionHeader, { backgroundColor: "#ABEBC6" }]}>
              <Image 
              ...
              <View style={styles.sectionTitleContainer}>
                ...
                <Text style={styles.sectionDescription}>Learn through video content</Text>
              </View>
            </View>
            ...
            {lessons.length > 0 ? (
              ...
              <View style={styles.noLessonsContainer}>
                <Text style={styles.noLessonsText}>No video lessons available yet</Text>
